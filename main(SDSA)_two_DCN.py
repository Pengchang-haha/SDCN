...
'''
    ...
    if args.paint_test:
        ...
        only_paint_samplePoint(args, test_loader, (1, 7), (3, 4), 7,
        ...
        for choose in [0, 1, 2, 3]:
            heatmap_dir = "./visualize_data/heatmap/two_DCN"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--resume',
                        # default="/home/cyl/文档/work/daimai可视化/dwcheckpoints/SDSA-10-10-lr=0.0001-bs=2-69.96517-0.78542-0.81516-ep151-best",
                        # default="/home/cyl/文档/work/daimai可视化/model/one_deformable/SDSA-10-10-lr=8e-05-bs=2-71.15027-0.76700-0.80866-ep180",
                        default="D:/1pengchang/project_deformable/model/two_deformable/SDSA-10-10-lr=1e-05-bs=2-73.24872-0.76984-0.79620-ep140",
                        type=str,
