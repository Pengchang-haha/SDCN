...
if __name__ == "__main__":
    deformable_conv2d = DeformConv2d(in_dim=3, out_dim=4, kernel_size=1, offset_groups=3, with_mask=False)
    #print(deformable_conv2d(torch.randn(1, 3, 5, 7)).shape)
    print(deformable_conv2d(torch.randn(1, 3, 5, 7)))
    #deformable_conv2d = DeformConv2d(in_dim=3, out_dim=6, kernel_size=1, groups=3, offset_groups=3, with_mask=True)
    #print(deformable_conv2d(torch.randn(1, 3, 5, 7)).shape)